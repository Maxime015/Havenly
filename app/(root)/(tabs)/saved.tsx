...
export default function SavedScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      {/* Header */}
      <View className="-mt-4 px-5 pt-4 pb-3">
        <View className="absolute top-6 left-0 right-0" pointerEvents="none">
          <TabScreenBackground />
        </View>
        <Text className="text-2xl font-bold text-card-foreground">Saved</Text>
        {!loading && (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View className="flex-1 items-center justify-center py-24">
              ...
              <Text className="text-ring text-sm text-center px-8">
