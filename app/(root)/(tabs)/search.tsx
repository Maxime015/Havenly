  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      ...
      <View className="px-5 pt-4 ">
        ...
        <Text className="-mt-4 text-xl font-bold text-card-foreground mb-2">
          Find Property
        </Text>
        ...
        <View className="flex-row items-center gap-3">
          <View
            className="flex-1 flex-row items-center border border-border bg-card rounded-2xl px-4 gap-3"
            style={{
              shadowColor: "#000",
          ...
          >
            ...
            <TextInput
              className="flex-1 py-3 text-card-foreground"
          ...
          <TouchableOpacity
            ...
            className={`w-12 h-12 rounded-2xl items-center justify-center ${
              activeFilterCount > 0 ? "bg-blue-600" : "bg-primary"
            }`}
            style={{
              shadowColor: "#000",
              shadowOffset: { width: 0, height: 1 },
          ...
          >
            <Ionicons
              ...
              size={20}
              color={activeFilterCount > 0 ? "#fff" : "#fff"}
            />
            {activeFilterCount > 0 && (
