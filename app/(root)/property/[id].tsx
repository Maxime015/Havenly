...
export default function PropertyDetailScreen() {
  ...
  // Couleurs dynamiques pour les composants natifs
  ...
  if (!property) {
    return (
      <View className="flex-1 items-center justify-center bg-background">
        <Text className="text-muted-foreground">Property not found</Text>
      </View>
    );
  }
    ...
    <View className="flex-1 bg-background">
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          {/* Specs Row */}
          <View className="flex-row justify-between bg-card border border-border rounded-2xl p-4 mb-5">
            <SpecItem
              icon="bed-outline"
              label="Beds"
          ...
          <Text className="text-muted-foreground text-sm leading-6 mb-1">
            {displayDesc}
          </Text>
          {isLongDesc && (
            <TouchableOpacity onPress={() => setExpanded(!expanded)}>
              <Text className="text-primary text-sm font-medium mb-5">
          ...
          >
            <WebView
              ...
              pointerEvents="none"
            />
            <View className="absolute bottom-3 right-3 bg-card/90 px-3 py-1 rounded-full flex-row items-center gap-1 border border-border">
              <Ionicons name="expand-outline" size={12} color={iconColor} />
          ...
          <TouchableOpacity
            ...
            className="flex-row items-center justify-center gap-2 bg-primary py-4 rounded-2xl mb-4"
          >
            ...
            <View className="flex-row gap-3">
              {!property.is_sold && (
                <TouchableOpacity
                  ...
                  className="flex-1 flex-row items-center justify-center gap-2 bg-secondary py-4 rounded-2xl border border-border"
                >
                  <Ionicons
              ...
              <TouchableOpacity
                ...
                className="flex-1 flex-row items-center justify-center gap-2 bg-destructive py-4 rounded-2xl border border-destructive"
              >
                <Ionicons
                  name="trash-outline"
                  size={18}
...
function SpecItem({
  ...
  const colorScheme = useColorScheme();
  const primaryColor = colorScheme === "dark" ? "#38bdf8" : "#2563EB";
