...
export default function PropertyCard({
  ...
  return (
    <TouchableOpacity
      ...
      className="flex-row border border-border bg-secondary rounded-2xl mb-4 overflow-hidden"
      style={{
        shadowColor: "#000",
    ...
    >
      ...
      <View className="flex-1 p-3 justify-between">
        <View>
          <Text
            className="text-sm font-bold text-card-foreground mb-1"
            numberOfLines={1}
          >
            {property.title}
          </Text>
          <View className="flex-row items-center gap-1">
            ...
            <Text
              className="text-sm font-semibold uppercase tracking-[1px] text-card-foreground"
              numberOfLines={1}
            >
              {property.city}
            </Text>
